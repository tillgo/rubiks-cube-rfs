...
public class Utils {
    ...
    public static boolean comparePositions(Pose pose1, Pose pose2) {
        double toleranz = 0.00008;
        double toleranzR = 0.005;
        return Math.abs(pose1.getPosition().getX() - pose2.getPosition().getX()) < toleranz
                ...
                && Math.abs(pose1.getOrientation().getX() - pose2.getOrientation().getX()) < toleranzR
                && Math.abs(pose1.getOrientation().getY() - pose2.getOrientation().getY()) < toleranzR
                && Math.abs(pose1.getOrientation().getZ() - pose2.getOrientation().getZ()) < toleranzR
        ;
